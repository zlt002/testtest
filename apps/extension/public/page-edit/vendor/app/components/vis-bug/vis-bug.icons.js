...
export const palette = `
  <svg viewBox="0 0 24 24">
    <path d="M12 3C7.03 3 3 6.58 3 11c0 4.08 3.44 7.42 7.78 7.94.72.09 1.22-.56 1.22-1.16 0-.33-.13-.63-.34-.86-.21-.24-.34-.55-.34-.92 0-.83.67-1.5 1.5-1.5H14c3.87 0 7-2.91 7-6.5C21 5.69 16.97 3 12 3zm-4 8.5A1.5 1.5 0 1 1 8 8.5a1.5 1.5 0 0 1 0 3zm3-4A1.5 1.5 0 1 1 11 4.5 1.5 1.5 0 0 1 11 7.5zm5 0A1.5 1.5 0 1 1 16 4.5 1.5 1.5 0 0 1 16 7.5zm2.5 4A1.5 1.5 0 1 1 18.5 8a1.5 1.5 0 0 1 0 3z"/>
  </svg>
`
...
export const save = `
  <svg viewBox="0 0 24 24">
    <path d="M17 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7zM7 5h8v4H7zm5 14a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
  </svg>
`

export const toggle_actions = `
  <svg viewBox="0 0 24 24">
    <path d="M7 7h10a4 4 0 1 1 0 8H7a4 4 0 1 1 0-8zm0 2a2 2 0 1 0 0 4h10a2 2 0 1 0 0-4zm0 1.25a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5z"/>
  </svg>
`
