...
export const notList = ':not(vis-bug):not(script):not(.visbug-metatip):not(visbug-label):not(visbug-handles):not(visbug-selected):not(visbug-corners):not(visbug-grip):not(visbug-gridlines):not([data-webmcp-annotation-ui="true"])'
