...
export function BoxShadow({selection, recordStyleMutation}) {
  ...
  hotkeys(command_events, (e, handler) => {
    ...
    recordStyleMutation({
      elements: selectedNodes,
      label: 'box-shadow-command',
      mutate: () => keys.includes('left') || keys.includes('right')
        ? changeBoxShadow(selectedNodes, keys, 'opacity')
        : changeBoxShadow(selectedNodes, keys, 'inset'),
    })
  })
